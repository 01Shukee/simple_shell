...
/**
 * initialize_tokens - initializes token struct
 * @tokens: tokens struct to initialize
 * @length: length to malloc for
 */
void initialize_tokens(tokens_t *tokens, int length)
{
...
/**
 * release_tokens - freeing tokens
 * @tokens: tokens_t struct with tokens
 * Return: 0
 */
int release_tokens(tokens_t *tokens)
{
    unsigned int i;
...
/**
 * remove_duplicates - deletes duplicate semi-colons from data
 * @tokens: tokens_t struct
 */
void remove_duplicates(tokens_t *tokens)
{
...
/**
 * classify_tokens - classifies the tokens
 * @tokens: tokens_t struct
 */
void classify_tokens(tokens_t *tokens)
{
    unsigned int i;
    int j;
